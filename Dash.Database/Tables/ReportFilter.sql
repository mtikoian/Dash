CREATE TABLE [dbo].[ReportFilter] (
    ...
    CONSTRAINT [FK_ReportFilter_UserCreated] FOREIGN KEY ([UserCreated]) REFERENCES [dbo].[User] ([Id]),
    CONSTRAINT [FK_ReportFilter_UserUpdated] FOREIGN KEY ([UserUpdated]) REFERENCES [dbo].[User] ([Id])
);
