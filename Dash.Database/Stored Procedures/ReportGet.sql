...
AS
	...
	SELECT r.Id, r.DatasetId, r.Name, r.RowLimit, r.XAxisColumnId, r.ChartDateIntervalId,
		r.YAxisColumnId, r.ChartAggregatorId, r.ChartTypeId, r.OwnerId, r.Width, r.AggregatorId, d.Name AS DatasetName, d.DatabaseId, r.DateCreated, ISNULL(r.DateUpdated, r.DateCreated) AS DateUpdated
	FROM @Ids i
