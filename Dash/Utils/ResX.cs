        ...
        public static Dictionary<string, string> Build(ClaimsPrincipal user)
        {
            ...
            if (user.IsInRole("dashboard.index") || user.IsInRole("report.index"))
            {
                resources.AddRange(new Dictionary<string, string> {
                    ...
                    { "report.filterColumnText", ContextHelp.ReportFilter_ColumnId },
                    { "report.filterOperatorText", ContextHelp.ReportFilter_OperatorId },
                    { "report.filterCriteriaText", ContextHelp.ReportFilter_Criteria },
