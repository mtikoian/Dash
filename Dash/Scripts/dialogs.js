...
(function(m, $, Alertify, Dialog, Table, Tab, CollapsibleList, DatePicker) {
    ...
    var _contentActions = [
        ...
        {
            selector: '.toast-dismiss', action: function() {
                $.on(this, 'click', $.hide.bind(null, this.parentNode, false));
            }
        }
    ];
    ...
    var handleResponseContent = function(responseData) {
        ...
        openDialog($.isNull(responseData.component) ? responseData.content : responseData);
    };
