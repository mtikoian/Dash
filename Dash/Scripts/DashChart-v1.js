            ...
            $.ajax({
                ...
                if (self.chart) {
                    ...
                    switch (chartType) {
                        case 'horizontalbar':
                        case 'line':
                            self.chart = chart.Line(chartData.data, chartData.options);
                            break;
                        case 'bar':
                            self.chart = chart.Bar(chartData.data, chartData.options);
                            break;
                        case 'pie':
                            self.chart = chart.Pie(chartData.data, chartData.options);
                            break;
                        case 'doughnut':
                            self.chart = chart.Doughnut(chartData.data, chartData.options);
                            break;
                        default:
                            self.chart = chart.Line(chartData.data, chartData.options);
                            break;
